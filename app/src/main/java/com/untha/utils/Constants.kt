...
object Constants {
    ...
    const val MARGIN_TOP_PERCENTAGE = 0.011
    ...
    const val SIZE_MARGIN_IMAGE = 0.051
    ...
    const val WIDTH_TWO_INCHES_DEVICES = 320
    const val PADDING_FOR_IMAGES_IN_TWO_INCHES_DEVICES = 5
    ...
    const val NAME_SCREEN_CALCULATOR_ROUTE = "CALCULAR FINIQUITO"
    ...
    const val CALCULATOR_FINIQUITO_RESULT_PAGE: String = "RESULTADOS FINIQUITO"
